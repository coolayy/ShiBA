...
import com.cheng.shibabiangan.R;
...
public class AssetsLoad {
	...
	private static void picLoad(Context context) {
		...
		noWin = BitmapFactory.decodeResource(res, R.drawable.no_win);
	...
	/*public static void prepareBackgroundMusic(Context context) {
		...
		player.setVolume(volume / 2.0f, volume / 2.0f);
	}*/
